...
/** Update an existing pet*/ export async function updatePetUsingPut(req: {
    "body"?: unknown;
}) { return fetch(`/pet`, {
    method: "PUT",
    body: JSON.stringify(req)
}).then(async (response) => (await response.json()) as unknown); }
/** Add a new pet to the store*/ export async function addPetUsingPost(req: {
    "body"?: unknown;
}) { return fetch(`/pet`, {
    method: "POST",
    body: JSON.stringify(req)
...
/** Creates list of users with given input array*/ export async function createUsersWithArrayInputUsingPost(req: {
    "body"?: unknown;
}) { return fetch(`/user/createWithArray`, {
    method: "POST",
    body: JSON.stringify(req)
}).then(async (response) => (await response.json()) as unknown); }
/** Creates list of users with given input array*/ export async function createUsersWithListInputUsingPost(req: {
    "body"?: unknown;
