...
/** Searching animals*/ export async function animalSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "canine": boolean;
    "feline": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("earthAnimal", String(req.earthAnimal)); fd.append("earthInsect", String(req.earthInsect)); fd.append("avian", String(req.avian)); fd.append("canine", String(req.canine)); fd.append("feline", String(req.feline)); return fetch(`/api/animal/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as AnimalBaseResponse); }
...
/** Searching astronomical objects*/ export async function astronomicalObjectSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "locationUid": string;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("astronomicalObjectType", req.astronomicalObjectType); fd.append("locationUid", req.locationUid); return fetch(`/api/astronomicalObject/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as AstronomicalObjectBaseResponse); }
...
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("novel", String(req.novel)); fd.append("referenceBook", String(req.referenceBook)); fd.append("biographyBook", String(req.biographyBook)); fd.append("rolePlayingBook", String(req.rolePlayingBook)); fd.append("eBook", String(req.eBook)); fd.append("anthology", String(req.anthology)); fd.append("novelization", String(req.novelization)); fd.append("audiobook", String(req.audiobook)); fd.append("audiobookAbridged", String(req.audiobookAbridged)); fd.append("audiobookPublishedYearFrom", String(req.audiobookPublishedYearFrom)); fd.append("audiobookPublishedYearTo", String(req.audiobookPublishedYearTo)); fd.append("audiobookRunTimeFrom", String(req.audiobookRunTimeFrom)); fd.append("audiobookRunTimeTo", String(req.audiobookRunTimeTo)); return fetch(`/api/book/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as BookBaseResponse); }
...
/** Searching book collections*/ export async function bookCollectionSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "yearFrom": number;
    "yearTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); return fetch(`/api/bookCollection/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as BookCollectionBaseResponse); }
...
/** Searching book series*/ export async function bookSeriesSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "miniseries": boolean;
    "eBookSeries": boolean;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfBooksFrom", String(req.numberOfBooksFrom)); fd.append("numberOfBooksTo", String(req.numberOfBooksTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("miniseries", String(req.miniseries)); fd.append("eBookSeries", String(req.eBookSeries)); return fetch(`/api/bookSeries/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as BookSeriesBaseResponse); }
...
/** Searching characters*/ export async function characterSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "mirror": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("gender", req.gender); fd.append("deceased", String(req.deceased)); fd.append("hologram", String(req.hologram)); fd.append("fictionalCharacter", String(req.fictionalCharacter)); fd.append("mirror", String(req.mirror)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/character/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as CharacterBaseResponse); }
...
/** Searching comics*/ export async function comicsSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "photonovel": boolean;
    "adaptation": boolean;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("photonovel", String(req.photonovel)); fd.append("adaptation", String(req.adaptation)); return fetch(`/api/comics/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ComicsBaseResponse); }
...
/** Searching comic collections*/ export async function comicCollectionSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "yearTo": number;
    "photonovel": boolean;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("photonovel", String(req.photonovel)); return fetch(`/api/comicCollection/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ComicCollectionBaseResponse); }
...
/** Searching comic series*/ export async function comicSeriesSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "miniseries": boolean;
    "photonovelSeries": boolean;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfIssuesFrom", String(req.numberOfIssuesFrom)); fd.append("numberOfIssuesTo", String(req.numberOfIssuesTo)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("miniseries", String(req.miniseries)); fd.append("photonovelSeries", String(req.photonovelSeries)); return fetch(`/api/comicSeries/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ComicSeriesBaseResponse); }
...
/** Searching comic strips*/ export async function comicStripSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "yearFrom": number;
    "yearTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); return fetch(`/api/comicStrip/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ComicStripBaseResponse); }
...
/** Searching companies*/ export async function companySearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "tvAndFilmProductionCompany": boolean;
    "videoGameCompany": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("broadcaster", String(req.broadcaster)); fd.append("collectibleCompany", String(req.collectibleCompany)); fd.append("conglomerate", String(req.conglomerate)); fd.append("digitalVisualEffectsCompany", String(req.digitalVisualEffectsCompany)); fd.append("distributor", String(req.distributor)); fd.append("gameCompany", String(req.gameCompany)); fd.append("filmEquipmentCompany", String(req.filmEquipmentCompany)); fd.append("makeUpEffectsStudio", String(req.makeUpEffectsStudio)); fd.append("mattePaintingCompany", String(req.mattePaintingCompany)); fd.append("modelAndMiniatureEffectsCompany", String(req.modelAndMiniatureEffectsCompany)); fd.append("postProductionCompany", String(req.postProductionCompany)); fd.append("productionCompany", String(req.productionCompany)); fd.append("propCompany", String(req.propCompany)); fd.append("recordLabel", String(req.recordLabel)); fd.append("specialEffectsCompany", String(req.specialEffectsCompany)); fd.append("tvAndFilmProductionCompany", String(req.tvAndFilmProductionCompany)); fd.append("videoGameCompany", String(req.videoGameCompany)); return fetch(`/api/company/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as CompanyBaseResponse); }
...
/** Searching conflicts*/ export async function conflictSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "dominionWarBattle": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("earthConflict", String(req.earthConflict)); fd.append("federationWar", String(req.federationWar)); fd.append("klingonWar", String(req.klingonWar)); fd.append("dominionWarBattle", String(req.dominionWarBattle)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/conflict/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ConflictBaseResponse); }
...
/** Searching elements*/ export async function elementSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "transonicSeries": boolean;
    "worldSeries": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("symbol", req.symbol); fd.append("transuranium", String(req.transuranium)); fd.append("gammaSeries", String(req.gammaSeries)); fd.append("hypersonicSeries", String(req.hypersonicSeries)); fd.append("megaSeries", String(req.megaSeries)); fd.append("omegaSeries", String(req.omegaSeries)); fd.append("transonicSeries", String(req.transonicSeries)); fd.append("worldSeries", String(req.worldSeries)); return fetch(`/api/element/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as ElementBaseResponse); }
...
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("seasonNumberFrom", String(req.seasonNumberFrom)); fd.append("seasonNumberTo", String(req.seasonNumberTo)); fd.append("episodeNumberFrom", String(req.episodeNumberFrom)); fd.append("episodeNumberTo", String(req.episodeNumberTo)); fd.append("productionSerialNumber", req.productionSerialNumber); fd.append("featureLength", String(req.featureLength)); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("usAirDateFrom", req.usAirDateFrom); fd.append("usAirDateTo", req.usAirDateTo); fd.append("finalScriptDateFrom", req.finalScriptDateFrom); fd.append("finalScriptDateTo", req.finalScriptDateTo); return fetch(`/api/episode/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as EpisodeBaseResponse); }
...
/** Searching foods*/ export async function foodSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "juice": boolean;
    "tea": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("earthlyOrigin", String(req.earthlyOrigin)); fd.append("dessert", String(req.dessert)); fd.append("fruit", String(req.fruit)); fd.append("herbOrSpice", String(req.herbOrSpice)); fd.append("sauce", String(req.sauce)); fd.append("soup", String(req.soup)); fd.append("beverage", String(req.beverage)); fd.append("alcoholicBeverage", String(req.alcoholicBeverage)); fd.append("juice", String(req.juice)); fd.append("tea", String(req.tea)); return fetch(`/api/food/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as FoodBaseResponse); }
...
/** Searching literature*/ export async function literatureSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "technicalManual": boolean;
    "religiousLiterature": boolean;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("earthlyOrigin", String(req.earthlyOrigin)); fd.append("shakespeareanWork", String(req.shakespeareanWork)); fd.append("report", String(req.report)); fd.append("scientificLiterature", String(req.scientificLiterature)); fd.append("technicalManual", String(req.technicalManual)); fd.append("religiousLiterature", String(req.religiousLiterature)); return fetch(`/api/literature/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as LiteratureBaseResponse); }
...
/** Searching locations*/ export async function locationSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "mirror": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("earthlyLocation", String(req.earthlyLocation)); fd.append("fictionalLocation", String(req.fictionalLocation)); fd.append("religiousLocation", String(req.religiousLocation)); fd.append("geographicalLocation", String(req.geographicalLocation)); fd.append("bodyOfWater", String(req.bodyOfWater)); fd.append("country", String(req.country)); fd.append("subnationalEntity", String(req.subnationalEntity)); fd.append("settlement", String(req.settlement)); fd.append("usSettlement", String(req.usSettlement)); fd.append("bajoranSettlement", String(req.bajoranSettlement)); fd.append("colony", String(req.colony)); fd.append("landform", String(req.landform)); fd.append("landmark", String(req.landmark)); fd.append("road", String(req.road)); fd.append("structure", String(req.structure)); fd.append("shipyard", String(req.shipyard)); fd.append("buildingInterior", String(req.buildingInterior)); fd.append("establishment", String(req.establishment)); fd.append("medicalEstablishment", String(req.medicalEstablishment)); fd.append("ds9Establishment", String(req.ds9Establishment)); fd.append("school", String(req.school)); fd.append("mirror", String(req.mirror)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/location/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as LocationBaseResponse); }
...
/** Searching magazines*/ export async function magazineSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "numberOfPagesFrom": number;
    "numberOfPagesTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfPagesFrom", String(req.numberOfPagesFrom)); fd.append("numberOfPagesTo", String(req.numberOfPagesTo)); return fetch(`/api/magazine/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as MagazineBaseResponse); }
...
/** Searching magazine series*/ export async function magazineSeriesSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "numberOfIssuesFrom": number;
    "numberOfIssuesTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("publishedYearFrom", String(req.publishedYearFrom)); fd.append("publishedYearTo", String(req.publishedYearTo)); fd.append("numberOfIssuesFrom", String(req.numberOfIssuesFrom)); fd.append("numberOfIssuesTo", String(req.numberOfIssuesTo)); return fetch(`/api/magazineSeries/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as MagazineSeriesBaseResponse); }
...
/** Searching materials*/ export async function materialSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "mineral": boolean;
    "preciousMaterial": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("chemicalCompound", String(req.chemicalCompound)); fd.append("biochemicalCompound", String(req.biochemicalCompound)); fd.append("drug", String(req.drug)); fd.append("poisonousSubstance", String(req.poisonousSubstance)); fd.append("explosive", String(req.explosive)); fd.append("gemstone", String(req.gemstone)); fd.append("alloyOrComposite", String(req.alloyOrComposite)); fd.append("fuel", String(req.fuel)); fd.append("mineral", String(req.mineral)); fd.append("preciousMaterial", String(req.preciousMaterial)); return fetch(`/api/material/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as MaterialBaseResponse); }
...
/** Searching medical conditions*/ export async function medicalConditionSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "name": string;
    "psychologicalCondition": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("psychologicalCondition", String(req.psychologicalCondition)); return fetch(`/api/medicalCondition/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as MedicalConditionBaseResponse); }
...
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("stardateFrom", String(req.stardateFrom)); fd.append("stardateTo", String(req.stardateTo)); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("usReleaseDateFrom", req.usReleaseDateFrom); fd.append("usReleaseDateTo", req.usReleaseDateTo); return fetch(`/api/movie/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as MovieBaseResponse); }
...
/** Searching occupations*/ export async function occupationSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "medicalOccupation": boolean;
    "scientificOccupation": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("legalOccupation", String(req.legalOccupation)); fd.append("medicalOccupation", String(req.medicalOccupation)); fd.append("scientificOccupation", String(req.scientificOccupation)); return fetch(`/api/occupation/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as OccupationBaseResponse); }
...
/** Searching organizations*/ export async function organizationSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "mirror": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("government", String(req.government)); fd.append("intergovernmentalOrganization", String(req.intergovernmentalOrganization)); fd.append("researchOrganization", String(req.researchOrganization)); fd.append("sportOrganization", String(req.sportOrganization)); fd.append("medicalOrganization", String(req.medicalOrganization)); fd.append("militaryOrganization", String(req.militaryOrganization)); fd.append("militaryUnit", String(req.militaryUnit)); fd.append("governmentAgency", String(req.governmentAgency)); fd.append("lawEnforcementAgency", String(req.lawEnforcementAgency)); fd.append("prisonOrPenalColony", String(req.prisonOrPenalColony)); fd.append("mirror", String(req.mirror)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/organization/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as OrganizationBaseResponse); }
...
/** Searching performers*/ export async function performerSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "voicePerformer": boolean;
    "voyPerformer": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("birthName", req.birthName); fd.append("gender", req.gender); fd.append("dateOfBirthFrom", req.dateOfBirthFrom); fd.append("dateOfBirthTo", req.dateOfBirthTo); fd.append("placeOfBirth", req.placeOfBirth); fd.append("dateOfDeathFrom", req.dateOfDeathFrom); fd.append("dateOfDeathTo", req.dateOfDeathTo); fd.append("placeOfDeath", req.placeOfDeath); fd.append("animalPerformer", String(req.animalPerformer)); fd.append("disPerformer", String(req.disPerformer)); fd.append("ds9Performer", String(req.ds9Performer)); fd.append("entPerformer", String(req.entPerformer)); fd.append("filmPerformer", String(req.filmPerformer)); fd.append("standInPerformer", String(req.standInPerformer)); fd.append("stuntPerformer", String(req.stuntPerformer)); fd.append("tasPerformer", String(req.tasPerformer)); fd.append("tngPerformer", String(req.tngPerformer)); fd.append("tosPerformer", String(req.tosPerformer)); fd.append("videoGamePerformer", String(req.videoGamePerformer)); fd.append("voicePerformer", String(req.voicePerformer)); fd.append("voyPerformer", String(req.voyPerformer)); return fetch(`/api/performer/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as PerformerBaseResponse); }
...
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("seasonNumberFrom", String(req.seasonNumberFrom)); fd.append("seasonNumberTo", String(req.seasonNumberTo)); fd.append("numberOfEpisodesFrom", String(req.numberOfEpisodesFrom)); fd.append("numberOfEpisodesTo", String(req.numberOfEpisodesTo)); return fetch(`/api/season/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SeasonBaseResponse); }
...
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("abbreviation", req.abbreviation); fd.append("productionStartYearFrom", String(req.productionStartYearFrom)); fd.append("productionStartYearTo", String(req.productionStartYearTo)); fd.append("productionEndYearFrom", String(req.productionEndYearFrom)); fd.append("productionEndYearTo", String(req.productionEndYearTo)); fd.append("originalRunStartDateFrom", req.originalRunStartDateFrom); fd.append("originalRunStartDateTo", req.originalRunStartDateTo); fd.append("originalRunEndDateFrom", req.originalRunEndDateFrom); fd.append("originalRunEndDateTo", req.originalRunEndDateTo); return fetch(`/api/series/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SeriesBaseResponse); }
...
/** Searching soundtracks*/ export async function soundtrackSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "lengthFrom": number;
    "lengthTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("releaseDateFrom", req.releaseDateFrom); fd.append("releaseDateTo", req.releaseDateTo); fd.append("lengthFrom", String(req.lengthFrom)); fd.append("lengthTo", String(req.lengthTo)); return fetch(`/api/soundtrack/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SoundtrackBaseResponse); }
...
/** Searching spacecrafts*/ export async function spacecraftSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "name": string;
}) { const fd = new FormData(); fd.append("name", req.name); return fetch(`/api/spacecraft/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SpacecraftBaseResponse); }
...
/** Searching spacecraft classes*/ export async function spacecraftClassSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "warpCapableSpecies": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("warpCapableSpecies", String(req.warpCapableSpecies)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/spacecraftClass/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SpacecraftClassBaseResponse); }
...
/** Searching species*/ export async function speciesSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "unnamedSpecies": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("extinctSpecies", String(req.extinctSpecies)); fd.append("warpCapableSpecies", String(req.warpCapableSpecies)); fd.append("extraGalacticSpecies", String(req.extraGalacticSpecies)); fd.append("humanoidSpecies", String(req.humanoidSpecies)); fd.append("reptilianSpecies", String(req.reptilianSpecies)); fd.append("nonCorporealSpecies", String(req.nonCorporealSpecies)); fd.append("shapeshiftingSpecies", String(req.shapeshiftingSpecies)); fd.append("spaceborneSpecies", String(req.spaceborneSpecies)); fd.append("telepathicSpecies", String(req.telepathicSpecies)); fd.append("transDimensionalSpecies", String(req.transDimensionalSpecies)); fd.append("unnamedSpecies", String(req.unnamedSpecies)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/species/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as SpeciesBaseResponse); }
...
/** Searching staff*/ export async function staffSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "videoGameProductionStaff": boolean;
    "writer": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("birthName", req.birthName); fd.append("gender", req.gender); fd.append("dateOfBirthFrom", req.dateOfBirthFrom); fd.append("dateOfBirthTo", req.dateOfBirthTo); fd.append("placeOfBirth", req.placeOfBirth); fd.append("dateOfDeathFrom", req.dateOfDeathFrom); fd.append("dateOfDeathTo", req.dateOfDeathTo); fd.append("placeOfDeath", req.placeOfDeath); fd.append("artDepartment", String(req.artDepartment)); fd.append("artDirector", String(req.artDirector)); fd.append("productionDesigner", String(req.productionDesigner)); fd.append("cameraAndElectricalDepartment", String(req.cameraAndElectricalDepartment)); fd.append("cinematographer", String(req.cinematographer)); fd.append("castingDepartment", String(req.castingDepartment)); fd.append("costumeDepartment", String(req.costumeDepartment)); fd.append("costumeDesigner", String(req.costumeDesigner)); fd.append("director", String(req.director)); fd.append("assistantOrSecondUnitDirector", String(req.assistantOrSecondUnitDirector)); fd.append("exhibitAndAttractionStaff", String(req.exhibitAndAttractionStaff)); fd.append("filmEditor", String(req.filmEditor)); fd.append("linguist", String(req.linguist)); fd.append("locationStaff", String(req.locationStaff)); fd.append("makeupStaff", String(req.makeupStaff)); fd.append("musicDepartment", String(req.musicDepartment)); fd.append("composer", String(req.composer)); fd.append("personalAssistant", String(req.personalAssistant)); fd.append("producer", String(req.producer)); fd.append("productionAssociate", String(req.productionAssociate)); fd.append("productionStaff", String(req.productionStaff)); fd.append("publicationStaff", String(req.publicationStaff)); fd.append("scienceConsultant", String(req.scienceConsultant)); fd.append("soundDepartment", String(req.soundDepartment)); fd.append("specialAndVisualEffectsStaff", String(req.specialAndVisualEffectsStaff)); fd.append("author", String(req.author)); fd.append("audioAuthor", String(req.audioAuthor)); fd.append("calendarArtist", String(req.calendarArtist)); fd.append("comicArtist", String(req.comicArtist)); fd.append("comicAuthor", String(req.comicAuthor)); fd.append("comicColorArtist", String(req.comicColorArtist)); fd.append("comicInteriorArtist", String(req.comicInteriorArtist)); fd.append("comicInkArtist", String(req.comicInkArtist)); fd.append("comicPencilArtist", String(req.comicPencilArtist)); fd.append("comicLetterArtist", String(req.comicLetterArtist)); fd.append("comicStripArtist", String(req.comicStripArtist)); fd.append("gameArtist", String(req.gameArtist)); fd.append("gameAuthor", String(req.gameAuthor)); fd.append("novelArtist", String(req.novelArtist)); fd.append("novelAuthor", String(req.novelAuthor)); fd.append("referenceArtist", String(req.referenceArtist)); fd.append("referenceAuthor", String(req.referenceAuthor)); fd.append("publicationArtist", String(req.publicationArtist)); fd.append("publicationDesigner", String(req.publicationDesigner)); fd.append("publicationEditor", String(req.publicationEditor)); fd.append("publicityArtist", String(req.publicityArtist)); fd.append("cbsDigitalStaff", String(req.cbsDigitalStaff)); fd.append("ilmProductionStaff", String(req.ilmProductionStaff)); fd.append("specialFeaturesStaff", String(req.specialFeaturesStaff)); fd.append("storyEditor", String(req.storyEditor)); fd.append("studioExecutive", String(req.studioExecutive)); fd.append("stuntDepartment", String(req.stuntDepartment)); fd.append("transportationDepartment", String(req.transportationDepartment)); fd.append("videoGameProductionStaff", String(req.videoGameProductionStaff)); fd.append("writer", String(req.writer)); return fetch(`/api/staff/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as StaffBaseResponse); }
...
/** Searching technology*/ export async function technologySearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "medicalEquipment": boolean;
    "transporterTechnology": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("borgTechnology", String(req.borgTechnology)); fd.append("borgComponent", String(req.borgComponent)); fd.append("communicationsTechnology", String(req.communicationsTechnology)); fd.append("computerTechnology", String(req.computerTechnology)); fd.append("computerProgramming", String(req.computerProgramming)); fd.append("subroutine", String(req.subroutine)); fd.append("database", String(req.database)); fd.append("energyTechnology", String(req.energyTechnology)); fd.append("fictionalTechnology", String(req.fictionalTechnology)); fd.append("holographicTechnology", String(req.holographicTechnology)); fd.append("identificationTechnology", String(req.identificationTechnology)); fd.append("lifeSupportTechnology", String(req.lifeSupportTechnology)); fd.append("sensorTechnology", String(req.sensorTechnology)); fd.append("shieldTechnology", String(req.shieldTechnology)); fd.append("tool", String(req.tool)); fd.append("culinaryTool", String(req.culinaryTool)); fd.append("engineeringTool", String(req.engineeringTool)); fd.append("householdTool", String(req.householdTool)); fd.append("medicalEquipment", String(req.medicalEquipment)); fd.append("transporterTechnology", String(req.transporterTechnology)); return fetch(`/api/technology/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as TechnologyBaseResponse); }
...
/** Searching titles*/ export async function titleSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "position": boolean;
    "mirror": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("militaryRank", String(req.militaryRank)); fd.append("fleetRank", String(req.fleetRank)); fd.append("religiousTitle", String(req.religiousTitle)); fd.append("position", String(req.position)); fd.append("mirror", String(req.mirror)); return fetch(`/api/title/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as TitleBaseResponse); }
...
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("tradingCardDeckUid", req.tradingCardDeckUid); fd.append("tradingCardSetUid", req.tradingCardSetUid); return fetch(`/api/tradingCard/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as TradingCardBaseResponse); }
...
/** Searching trading card decks*/ export async function tradingCardDeckSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "name": string;
    "tradingCardSetUid": string;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("tradingCardSetUid", req.tradingCardSetUid); return fetch(`/api/tradingCardDeck/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as TradingCardDeckBaseResponse); }
...
/** Searching trading card sets*/ export async function tradingCardSetSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "cardHeightTo": number;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("releaseYearFrom", String(req.releaseYearFrom)); fd.append("releaseYearTo", String(req.releaseYearTo)); fd.append("cardsPerPackFrom", String(req.cardsPerPackFrom)); fd.append("cardsPerPackTo", String(req.cardsPerPackTo)); fd.append("packsPerBoxFrom", String(req.packsPerBoxFrom)); fd.append("packsPerBoxTo", String(req.packsPerBoxTo)); fd.append("boxesPerCaseFrom", String(req.boxesPerCaseFrom)); fd.append("boxesPerCaseTo", String(req.boxesPerCaseTo)); fd.append("productionRunFrom", String(req.productionRunFrom)); fd.append("productionRunTo", String(req.productionRunTo)); fd.append("productionRunUnit", req.productionRunUnit); fd.append("cardWidthFrom", String(req.cardWidthFrom)); fd.append("cardWidthTo", String(req.cardWidthTo)); fd.append("cardHeightFrom", String(req.cardHeightFrom)); fd.append("cardHeightTo", String(req.cardHeightTo)); return fetch(`/api/tradingCardSet/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as TradingCardSetBaseResponse); }
...
/** Searching video games*/ export async function videoGameSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "releaseDateFrom": string;
    "releaseDateTo": string;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("releaseDateFrom", req.releaseDateFrom); fd.append("releaseDateTo", req.releaseDateTo); return fetch(`/api/videoGame/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as VideoGameBaseResponse); }
...
/** Searching video releases*/ export async function videoReleaseSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "runTimeFrom": number;
    "runTimeTo": number;
}) { const fd = new FormData(); fd.append("title", req.title); fd.append("yearFrom", String(req.yearFrom)); fd.append("yearTo", String(req.yearTo)); fd.append("runTimeFrom", String(req.runTimeFrom)); fd.append("runTimeTo", String(req.runTimeTo)); return fetch(`/api/videoRelease/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as VideoReleaseBaseResponse); }
...
/** Searching weapons*/ export async function weaponSearchUsingPost({ pageNumber, pageSize, sort, apiKey }: {
    ...
    "mirror": boolean;
    "alternateReality": boolean;
}) { const fd = new FormData(); fd.append("name", req.name); fd.append("handHeldWeapon", String(req.handHeldWeapon)); fd.append("laserTechnology", String(req.laserTechnology)); fd.append("plasmaTechnology", String(req.plasmaTechnology)); fd.append("photonicTechnology", String(req.photonicTechnology)); fd.append("phaserTechnology", String(req.phaserTechnology)); fd.append("mirror", String(req.mirror)); fd.append("alternateReality", String(req.alternateReality)); return fetch(`/api/weapon/search?pageNumber=${pageNumber}&pageSize=${pageSize}&sort=${sort}&apiKey=${apiKey}`, {
    method: "POST",
    body: fd
}).then(async (response) => (await response.json()) as WeaponBaseResponse); }
