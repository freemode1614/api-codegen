...
export type MultischemaOfEverything = (ArrayOfObjectsOfObjectsAndArrays | {
    "objEverything": ObjectOfEverything;
    "flatObj": FlatObject;
}) | ArrayOfPrimitives | ArrayOfFlatObjects | FlatObject | ObjectOfEverything;
...
export type ObjectOfAdditionalPropertiesObjectPolymorphism = Record<string, unknown>;
...
export async function anythingTopLevelArrayUsingPut(req: ObjectOfEverything[]) { return fetch(`/anything/top-level-array`, {
    method: "PUT",
    body: JSON.stringify(req)
}).then(async (response) => (await response.json()) as ObjectOfEverything[]); }
export async function anythingTopLevelArrayUsingPost(req: FlatObject[]) { return fetch(`/anything/top-level-array`, {
    method: "POST",
    body: JSON.stringify(req)
...
export async function multischemaOfEverythingUsingPost(req: (ArrayOfObjectsOfObjectsAndArrays | {
    "objEverything": ObjectOfEverything;
    "flatObj": FlatObject;
}) | ArrayOfPrimitives | ArrayOfFlatObjects | FlatObject | ObjectOfEverything) { return fetch(`/multischema/of-everything`, {
    method: "POST",
    body: JSON.stringify(req)
}).then(async (response) => (await response.json()) as MultischemaOfEverything); }
