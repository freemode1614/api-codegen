...
var nodefs = require('fs/promises');
...
// node_modules/.pnpm/tsup@8.3.5_jiti@1.21.6_postcss@8.4.49_typescript@5.7.2_yaml@2.6.1/node_modules/tsup/assets/cjs_shims.js
...
async function formatCode(code, options = {}) {
  try {
    ...
    const formattedCode = await prettier__namespace.format(code, defaultOptions);
...
async function writeToFile(filePath, data) {
  try {
    await nodefs__default.default.writeFile(filePath, data);
  } catch (error) {
    console.error(error);
  }
}
...
exports.codeGenByConfigForTesting = codeGenByConfigForTesting;
