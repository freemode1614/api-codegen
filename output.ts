...
export async function findPetsByStatusUsingGet({ status }: { status: string[] }) {
...
export async function updatePetWithFormUsingPost({ name, status }: { name: string; status: string }) {
...
export async function deletePetUsingDelete({ api_key, petId }: { api_key?: string; petId: number }) {
  return fetch(`/pet/{petId}?`, {
    method: "DELETE",
    // headers: {
    //   {{headers}}
...
export async function uploadFileUsingPost({ additionalMetadata, file }: { additionalMetadata: string; file: Blob }) {
  const fd = new FormData();
...
export async function loginUserUsingGet({ username, password }: { username: string; password: string }) {
...
export async function getUserByNameUsingGet({ username }: { username: string }) {
...
export async function deleteUserUsingDelete({ username }: { username: string }) {
  return fetch(`/user/{username}?`, {
    method: "DELETE",
    // headers: {
    //   {{headers}}
