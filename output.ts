...
export async function uploadFileUsingPost(
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-expressions
  req["file"] && fd.append("file", String(req["file"]));
...
*/
export async function updatePetUsingPut(req: { body?: unknown }) {
  return fetch(`/pet`, {
    method: "PUT",
...
*/
export async function addPetUsingPost(req: { body?: unknown }) {
  return fetch(`/pet`, {
    method: "POST",
    body: JSON.stringify(req),
  }).then(async (response) => (await response.json()) as unknown);
...
*/
export async function placeOrderUsingPost(req: { body?: unknown }) {
...
This can only be done by the logged in user.
 Create user
*/
export async function createUserUsingPost(req: { body?: unknown }) {
  return fetch(`/user`, {
    method: "POST",
    body: JSON.stringify(req),
  }).then(async (response) => (await response.json()) as unknown);
