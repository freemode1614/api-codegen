  ...
  private toBaseSchema(
    ...
    if (schema.type === "array") {
      ...
      return {
        ...
        allOf: allOf.map((s) => this.toBaseSchema(s as OpenAPIV2.SchemaObject)),
        anyOf: anyOf.map((s) => this.toBaseSchema(s as OpenAPIV2.SchemaObject)),
        oneOf: oneOf.map((s) => this.toBaseSchema(s as OpenAPIV2.SchemaObject)),
